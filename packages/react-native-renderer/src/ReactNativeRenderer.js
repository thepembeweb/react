...
export function unmountComponentAtNodeAndRemoveContainer(containerTag: number) {
...
export const NativeComponent = ReactNativeComponent;
export const findNodeHandle = findNumericNodeHandle;
export const unstable_batchedUpdates = ReactGenericBatching.batchedUpdates;
export const flushSync = ReactNativeFiberRenderer.flushSync;
